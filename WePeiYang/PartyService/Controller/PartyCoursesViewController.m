...
- (instancetype)init {
    ...
    if (self) {
        NSLog(@"FUCK");
        self.viewControllerClasses = @[[TwentyCourseTableViewController class], [TheoryClassicsTableViewController class]];
        NSLog(@"FUCKagain");
...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithText: @"课程学习" color:[UIColor whiteColor]];
