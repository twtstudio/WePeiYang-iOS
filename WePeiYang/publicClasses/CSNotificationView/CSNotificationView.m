           ...
           message:(NSString *)message
{
    ...
    switch (style) {
        case CSNotificationViewStyleSuccess:
            ...
            image = [UIImage imageNamed:@"success_tick.png"];
            break;
        case CSNotificationViewStyleError:
            blurTintColor = [UIColor colorWithRed:1.0 green:0.20 blue:0.20 alpha:0.2];
            image = [UIImage imageNamed:@"error_cross.png"];
            break;
        default:
